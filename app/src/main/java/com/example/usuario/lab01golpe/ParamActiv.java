...
public class ParamActiv extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // variables
        et_count = (EditText) findViewById(R.id.et_count_param);
        main_activ_but = (Button) findViewById(R.id.main_activ_but_param);
        param_activ_but = (Button) findViewById(R.id.param_activ_but_param);
        result_activ_but = (Button) findViewById(R.id.result_activ_but_param);
