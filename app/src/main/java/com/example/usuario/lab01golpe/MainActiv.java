...
public class MainActiv extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // variables
        et_count = (EditText) findViewById(R.id.et_count_main);
        main_activ_but = (Button) findViewById(R.id.main_activ_but_main);
        param_activ_but = (Button) findViewById(R.id.param_activ_but_main);
        result_activ_but = (Button) findViewById(R.id.result_activ_but_main);
